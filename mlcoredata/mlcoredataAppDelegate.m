...
@synthesize window;
@synthesize insertResults;

- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    
    insertResults = [[NSMutableString alloc] init];
    [self invokeUtility];
...
- (NSPersistentStoreCoordinator *) persistentStoreCoordinator {
    ...
    NSURL *momURLReadOnly = [NSURL fileURLWithPath:@"/Users/aaxe/Documents/projects/teamaxe/code/moralife/Classes/Model/SystemData.sqlite"];
...
- (NSPersistentStoreCoordinator *) readWritePersistentStoreCoordinator {
	...
	NSURL *momURLReadWrite = [NSURL fileURLWithPath:@"/Users/aaxe/Documents/projects/teamaxe/code/moralife/Classes/Model/UserData.sqlite"];    
...
- (NSManagedObjectContext *) readWriteManagedObjectContext {
    ...
    [__readWriteManagedObjectContext setPersistentStoreCoordinator:coordinator];
...
- (void) invokeUtility {
    ...
    [resultsView insertText:insertResults];
...
- (void)dealloc
{
    ...
    [__readWriteManagedObjectContext release];
    [__readWritePersistentStoreCoordinator release];
    [__readWriteManagedObjectModel release];
    [super dealloc];
}
